...
import { USERAPI, HOTELAPI } from "@constants/api";
...
export function getJourneyList(param) {
  const { uid } = param;
  const url = HOTELAPI + "/visit/user_info";
  const request = {
    uid
  };
  
  return post(url, request).then(res => {
    let data = res.data;
...
export function getJourneyDetails(param) {
  ...
  const url = HOTELAPI + "/visit/journey_info";
  const request = {
    journey_id
  };
...
export function getHotelsList() {
  const url = HOTELAPI + "/visit/hotels_info";
  const request = {};
...
export function getVagueRoomInfo(param) {
  ...
  const url = HOTELAPI + "/visit/room_info";
...
export function applyVisit(param) {
  ...
  const url = HOTELAPI + "/visit/send_visit";
