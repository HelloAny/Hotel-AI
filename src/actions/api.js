...
import { USERAPI, ZRKAPI } from "@constants/api";
...
export function getJourneyList(param) {
  const { uid } = param;
  const url = ZRKAPI + "/visit/user_info";
  const request = {
    uid
  };
...
export function getJourneyDetails(param) {
  ...
  const url = ZRKAPI + "/visit/journey_info";
  const request = {
    journey_id
  };
...
export function getHotelsList() {
  const url = ZRKAPI + "/visit/hotels_info";
  const request = {};
...
export function getVagueRoomInfo(param) {
  ...
  const url = ZRKAPI + "/visit/room_info";
...
export function applyVisit(param) {
  ...
  const url = ZRKAPI + "/visit/send_visit";
