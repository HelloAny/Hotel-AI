...
import ic_home_advertise from "../Reservation/ic_home_advertise.png"
...
class HomePage extends Taro.Component {
  ...
  selectCity() {
    Taro.navigateTo({
      url: '/packageB/Reservation/page/select_city/select_city'
    })
  }
          ...
          <View className="filterView">
            ...
            <View className="location">
              ...
              <View className="filter" onClick={this.nearbyTap}>
                <Image
                  src={require('./ic_home_advertise.png')}
                  mode="widthFix"
                  className="icon"
                ></Image>
